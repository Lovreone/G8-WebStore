        ...
        <div class="container stylish-div-background">
            ...
            <c:choose>
                <c:when test="${sessionScope.userid != null && sessionScope.isadmin == true}"> <%-- ADMIN ONLY --%>
                    ...
                    %>
                    <h3><a href="cms-product-manage.jsp">Manage Products</a> | <a href="cms-product-create.jsp">Create product</a></h3>
                    <h3>Editing product #<%=productId%></h3>

                    <form class="form-horizontal" method="post" action="ImageUpload" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="imageUpload" class="col-sm-2 control-label">Product Image (*):</label>
                            <div class="col-sm-5">
                    ...
                    <% // Automatic population of imagePath on image upload, user has to save
                        ...
                        if (newPath != null && !newPath.isEmpty()) oldPath = newPath;
                    %>

                    <form class="form-horizontal" action="ManageProducts" method="post">
                        <input type="hidden" name="productid" value="<%=p.getProductId()%>"/>
                            <div class="form-group">
                                <label for="inputImagePath" class="col-sm-2 control-label">ImagePath (*):</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label for="inputProductName" class="col-sm-2 control-label">Model name (*):</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label for="inputUnitPrice" class="col-sm-2 control-label">Price (*):</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label for="inputQtyInStock" class="col-sm-2 control-label">Stock (*):</label>
                                <div class="col-sm-10">
                    ...
                    <script>
                        function areYouSure() {
                          if (!confirm('You are about to permanently change this product!')) return false;
                        }
                    </script>
