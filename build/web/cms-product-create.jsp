        ...
        <div class="container stylish-div-background">
            ...
            <c:choose>
                <c:when test="${sessionScope.userid != null && sessionScope.isadmin == true}"> <%-- ADMIN ONLY --%>
                    <h3><a href="cms-product-manage.jsp">Manage Products</a> | <b>Create product</b></h3>
                    ...
                    <% // Automatic population of imagePath on image upload, user has to submit
                        ...
                        if (newPath != null && !newPath.isEmpty()) defaultPath = newPath;
                    %>
                    ...
                    <script>
                        function areYouSure() {
                            if (!confirm('You are about to add a product to database!')) return false; 
                        }
                    </script>
